...
final class S3BucketConfig {
    ...
    static final class Builder {
        ...
        Builder assumeRoleSessionDurationSeconds(int seconds) {
            this.assumeRoleSessionDurationSeconds = seconds;
            return this;
        }
        ...
        S3BucketConfig build() {
            boolean hasAccessKey = accessKey != null && !accessKey.isEmpty();
            boolean hasSecretKey = secretKey != null && !secretKey.isEmpty();
