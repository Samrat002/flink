...
s3.sse.kms.key-id: arn:aws:kms:region:account:key/id   # Optional: custom KMS key for SSE-KMS
s3.sse.kms.encryption-context: {"aws:s3:arn": "arn:aws:s3:::my-bucket/my-file"}  # Optional: KMS encryption context
